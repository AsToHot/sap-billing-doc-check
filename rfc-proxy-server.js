...
if (!sysnr) {
  ...
  console.warn(`[WARN] SAP_SYSNR not set in .env — falling back to port derivation: sysnr=${sysnr}`);
  console.warn(`       If this is wrong (e.g. port 8000 but sysnr=01), set SAP_SYSNR explicitly.`);
}
